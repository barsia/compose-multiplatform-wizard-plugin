package io.github.barsia.composewizard.shared.models
...
import io.github.barsia.composewizard.shared.WizardStrings
...
class ComposeMultiplatformModuleBuilder : ModuleBuilder() {
    ...
    override fun getCustomOptionsStep(context: com.intellij.ide.util.projectWizard.WizardContext?, parentDisposable: com.intellij.openapi.Disposable?): com.intellij.ide.util.projectWizard.ModuleWizardStep {
        return io.github.barsia.composewizard.shared.ui.ComposeWizardStep(this)
    }
    ...
    fun createProjectStructure(rootPath: String, projectName: String, useCache: Boolean = true) {
        io.github.barsia.composewizard.shared.ProjectCreator.createProjectStructure(
