...
class ComposeVersionService {
    ...
    init {
        ...
        val sorted = testVersions.sortedWith(compareByDescending { io.github.barsia.composewizard.shared.utils.ComposeVersionComparator.parse(it) })
        testVersions.forEach { v ->
            io.github.barsia.composewizard.shared.utils.ComposeVersionComparator.parse(v, debug = true)
        }
    }
