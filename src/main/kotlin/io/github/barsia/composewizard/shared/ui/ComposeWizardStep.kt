...
class ComposeWizardStep(
    ...
    private var projectPathValue = if (io.github.barsia.composewizard.shared.PlatformDetector.isAndroidStudio) {
    ...
    private fun syncStateFromUI(state: WizardState) {
        ...
        io.github.barsia.composewizard.shared.settings.WizardSettings.getInstance().enableDevVersions = state.enableDevVersions
    ...
    override fun updateDataModel() {
        ...
        val fullPath = if (io.github.barsia.composewizard.shared.PlatformDetector.isAndroidStudio) {
            expandedPath
        } else {
