...
fun ComposeVersionFieldWrapper(state: WizardState, modifier: Modifier = Modifier) {
    ComposeVersionField(
        cache = io.github.barsia.composewizard.shared.services.ComposeVersionCache.getInstance(),
        ...
        onDevVersionsToggle = { 
            ...
            io.github.barsia.composewizard.shared.settings.WizardSettings.getInstance().enableDevVersionsSetByUser = true
