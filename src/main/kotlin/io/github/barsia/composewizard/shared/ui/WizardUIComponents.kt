...
fun ProjectPathHint(projectPath: String, projectName: String, modifier: Modifier = Modifier) {
    val finalPath = if (io.github.barsia.composewizard.shared.PlatformDetector.isAndroidStudio) {
...
fun BundledLibraryIndicator() {
    Tooltip(
        tooltip = { Text("This version is bundled with the Compose Multiplatform release") },
        tooltipPlacement = TooltipPlacement.ComponentRect(
            anchor = Alignment.TopCenter,
            alignment = Alignment.TopCenter
        )
