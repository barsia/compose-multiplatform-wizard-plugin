...
class ModularResourceCopier {
    ...
    fun processAllFiles(dir: File, projectName: String, projectId: String, projectIdPath: String, composeVersion: String, config: io.github.heisiar.composewizard.generator.ProjectConfig? = null) {
    ...
    private fun processFile(file: File, projectName: String, projectId: String, projectIdPath: String, composeVersion: String, config: io.github.heisiar.composewizard.generator.ProjectConfig?) {
        try {
